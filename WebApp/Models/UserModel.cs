...
/// <param name="TotpSecrets">TOTP認証用シークレット</param>
...
public record UserModel(string ID, string Password, string Salt, string TotpSecrets, string Fullname, bool AdminRole, bool Disabled = true, int Version = 1)
{
    /// <summary>
    /// セッション名：ユーザー名称
    /// </summary>
